...
def main() -> None:
    with streamlit_analytics.track(load_from_json="data/analytics.json", save_to_json="data/analytics.json"):
        ...
        with header_col:
            st.markdown(
                """
                <div style='display: flex; flex-wrap: wrap; align-items: center; gap: 20px; margin-bottom: 0.5rem; position: relative;'>
                ...
                <p class='glowing-title' style='font-size:0.35rem; margin:0; margin-bottom: 0.8rem; opacity: 0.45; text-shadow: 0 0 5px rgba(0, 180, 216, 0.05);'>
